...
- I implemented a more robust agentic routing strategy that strictly scopes the assistant's responses to fleet-related topics, ensuring it provides relevant and focused answers without leaking internal application details.
